...
$(document).ready(function() {
    ...
    var setCardCenter = function(){
        cardWidth = $(".card-wrapper").width();
        cardHeight = $(".card-wrapper").height();
    ...
    $(".card-wrapper").mousemove(function(e){
        var moveAmount = 50;
        var parentOffset = $(this).offset(); 
        var offsetX = e.pageX - parentOffset.left;
        var offsetY = e.pageY - parentOffset.top;
        var valueX = cardCenter[0] - offsetX;
        var valueY = cardCenter[1] - offsetY; 
        var newvalueX = (valueX/moveAmount);
        var newvalueY = (valueY/moveAmount);

        $(this).find(".card-img").css({
            "-webkit-transform":"translate("+newvalueX+"px,"+newvalueY+"px) scale(0.975)",
            "-ms-transform":"translate("+newvalueX+"px,"+newvalueY+"px) scale(0.975)",
            "transform":"translate("+newvalueX+"px,"+newvalueY+"px) scale(0.975)"
        });

        // var bufferLeft = -(cardWidth - offsetX)+136; 

        // .velocity({
        //     translateX: bufferLeft+"px"
        // });

        // $(this).find(".card-info").css({
        //     "-webkit-transform":"translateX("+bufferLeft+"px)",
        //     "-ms-transform":"translateX("+bufferLeft+"px)",
        //     "transform":"translateX("+bufferLeft+"px)"
        // });

        // $(this).find(".card-img").velocity({
        //     translateX: newvalueX+"px",
        //     translateY: newvalueY+"px",
        //     translateZ: 0
        // });
        
    });

    $(".card-wrapper").mouseout(function(e){
        $(this).find(".card-img").css({
...
// enables smooth srolling on anchor links

$(function() {
    $("#js-drawer-open").click( function() {
        $("#js-drawer").removeClass("hidden");
        $(".header-open").addClass("hidden");
        return true;
    });
    $("#js-drawer-close").click( function() {
        $("#js-drawer").addClass("hidden");
        $(".header-open").removeClass("hidden");
        return true;
    });

    $("#js-form-link").click( function() {
        $("#js-form").removeClass("hidden");
        $(".footer-contact-note").removeClass("hidden");
        return true;
    });
     $("#js-form-link-2").click( function() {
        $("#js-form").removeClass("hidden");
        $(".footer-contact-note").removeClass("hidden");
        return true;
    });

    $("#js-note-link").click( function() {
        $("#js-form").removeClass("hidden");
        $(".footer-contact-note").removeClass("hidden");
        return true;
    });
    ...
    $("#js-form-close").click( function() {
        ...
        $(".footer-contact-note").addClass("hidden");
        return false;
    });

    $(".note").velocity({ opacity:0 , translateX: 40 });

    // $(".note").appear(function() {
    //   console.log("run");
    //     $(this).delay(150*index).velocity({ opacity:1 , translateY: 0 }, "easeOutQuad");
    // });

    $(".note").each(function(index) {
        $(this).delay(250*index).velocity({ opacity:1 , translateX: 0 }, "easeOutQuad");
  ...
  $('a[href*="#"]:not([href="#"])').click(function() {
    if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
      var target = $(this.hash);
        ...
        if (target.selector === "#js-form-spot") {
